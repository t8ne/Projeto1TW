...
<head>
  ...
  <style>
    ...
    .image {
      ...
      height: 100vh;
      background: green;
      background-image: url("images/destroy-lonely.jpg");
    ...
    .destroy-container {
      ...
      position: absolute;
      /* Altera de absolute para fixed */
      left: 50%;
      /* Mantém o alinhamento horizontal no meio */
      top: 50%;
      /* Mantém o alinhamento vertical no meio */
      transform: translate(20%,
          -45%);
      /* Reposiciona o elemento para o centro */
      font-size: 10px;
    }

    .destroy-container h2 {
      text-align: center;
      font-weight: bold;
    }
  ...
  <div class="image">
    ...
    <div class="destroy-container">
      ...
      <h3 style="font-family: 'Jockey One', serif">
        Bobby Wardell Sandimanie III, conhecido por seu nome artístico Destroy
        Lonely, filho do rapper I-20 que pertencia ao grupo do famoso
        Ludacris, é um rapper, cantor e compositor americano. O artista é o
        rapper que mais tenta incorporar aspetos visuais na sua música usando
        vídeoclipes esteticamente apelativos e sombrios assim como um trailer
        para o seu único álbum "If looks Could Kill".
      </h3>
    </div>
  </div>
  ...
  <script>
    const infoArista = async () => {
      const response = await fetch(
        "https://run.mocky.io/v3/4d3c7407-aeca-40c6-9cdc-7562d1b4270a"
      );
    ...
    const fetchTracks = async (albumId, index) => {
      const response = await fetch(
        [
          "https://run.mocky.io/v3/ffdfe325-c760-4887-ba7b-0c38456199d9",
          "https://run.mocky.io/v3/40916e69-82af-4890-8952-08915c711bf7",
          "https://run.mocky.io/v3/38f2e361-2006-4407-a90e-64ad7e96d5c1",
          "https://run.mocky.io/v3/316d8588-8051-4790-83bb-650a578c2e55",
        ][index]
      );
